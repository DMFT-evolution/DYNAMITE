...
|                | Name           |
| -------------- | -------------- |
| struct | **[SimulationConfig](Classes/structSimulationConfig.md)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| bool | **[parseCommandLineArguments](#function-parsecommandlinearguments)**(int argc, char ** argv) |
