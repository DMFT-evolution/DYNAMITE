---
title: include/EOMs/time_steps.hpp
...
|                | Name           |
| -------------- | -------------- |
| std::vector< double > | **[getLastLenEntries](#function-getlastlenentries)**(const std::vector< double > & vec, size_t len) |
| std::vector< double > | **[QKstep](#function-qkstep)**() |
| std::vector< double > | **[QRstep](#function-qrstep)**() |
| double | **[rstep](#function-rstep)**() |
| double | **[drstep](#function-drstep)**() |
| double | **[drstep2](#function-drstep2)**(const std::vector< double > & qK, const std::vector< double > & qR, const std::vector< double > & dqK, const std::vector< double > & dqR, const double t) |
| void | **[appendAll](#function-appendall)**(const std::vector< double > & qK, const std::vector< double > & qR, const std::vector< double > & dqK, const std::vector< double > & dqR, const double dr, const double t) |
| void | **[replaceAll](#function-replaceall)**(const std::vector< double > & qK, const std::vector< double > & qR, const std::vector< double > & dqK, const std::vector< double > & dqR, const double dr, const double t) |
...
```cpp
std::vector< double > getLastLenEntries(
