---
title: src/interpolation/interpolation_core.cpp
...
|                | Name           |
| -------------- | -------------- |
| void | **[interpolate](#function-interpolate)**(const vector< double > & posB1xIn, const vector< double > & posB2xIn, const bool same) |
...
```cpp
void interpolate(
    const vector< double > & posB1xIn,
    const vector< double > & posB2xIn,
    const bool same
)
```
