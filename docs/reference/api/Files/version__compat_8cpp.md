---
title: src/version/version_compat.cpp
...
|                | Name           |
| -------------- | -------------- |
| std::vector< int > | **[parseVersion](#function-parseversion)**(const std::string & version) |
| bool | **[areVersionsCompatible](#function-areversionscompatible)**(const std::string & v1, const std::string & v2) |
