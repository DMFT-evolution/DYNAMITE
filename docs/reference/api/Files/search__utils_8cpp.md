---
title: src/search/search_utils.cpp
...
|                | Name           |
| -------------- | -------------- |
| vector< double > | **[bsearchPosSorted](#function-bsearchpossorted)**(const vector< double > & list, const vector< double > & elem) |
| vector< double > | **[isearchPosSortedInit](#function-isearchpossortedinit)**(const vector< double > & list, const vector< double > & elem, const vector< double > & inits) |
...
```cpp
vector< double > bsearchPosSorted(
...
```cpp
vector< double > isearchPosSortedInit(
    const vector< double > & list,
    const vector< double > & elem,
    const vector< double > & inits
)
```
