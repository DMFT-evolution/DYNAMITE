---
title: include/core/vector_utils.hpp
...
|                | Name           |
| -------------- | -------------- |
| std::vector< double > & | **[operator+=](#function-operator+=)**(std::vector< double > & lhs, const std::vector< double > & rhs) |
| std::vector< double > | **[operator+](#function-operator+)**(const std::vector< double > & a, const std::vector< double > & b) |
| std::vector< double > | **[operator-](#function-operator-)**(const std::vector< double > & a, const std::vector< double > & b) |
| std::vector< double > | **[operator*](#function-operator*)**(const std::vector< double > & a, const std::vector< double > & b) |
| std::vector< double > | **[operator*](#function-operator*)**(const std::vector< double > & a, double s) |
| std::vector< double > | **[operator*](#function-operator*)**(double s, const std::vector< double > & a) |
